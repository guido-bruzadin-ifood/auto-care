...
public enum Codes {
	...
	/**
	 * * Expressao Regular - Find ^\t(P\d*{4}).(.*) - Replace \t$1(\"$2\"\,
	 */
...
//DTC Codes - P0100-P0199 - Fuel and Air Metering
	...
	P0109("Manifold Absolute Pressure/Barometric Pressure Circuit Intermittent or Intake Air Temperature Circuit Malfunction"),
...
//DTC Codes - P0700-P0899 - Transmission
	...
	private Codes(String descricao) {
